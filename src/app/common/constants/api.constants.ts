...
export const PRODUCT_API = {
    ...
    GET_PRODUCT_BY_CATEGORY_ID: PRODUCT_SERVICE+ 'getAllByCategory/',
    GET_PRODUCT_BY_BRAND_ID: PRODUCT_SERVICE+ 'getAllByBrand/',
    ADD_VARIATION: PRODUCT_SERVICE+'addVariation/',
    GET_VARIATION_BY_PRODUCT_ID: PRODUCT_SERVICE + 'getAllVariation/',
    GET_VARIATION_BY_ID: PRODUCT_SERVICE + 'getVariation/',
...
export const USER_ORDER_API = {
     ...
     ADD_USER_ORDER: USER_ORDER_SERVICE,
};

const RECOMMENDATION_SERVICE = SERVICE_API + 'api/recommendation/';
export const RECOMMENDATION_API = {
     GET_ITEM_RECOMMENDED_PRODUCT: RECOMMENDATION_SERVICE +'itemBased/',
     GET_USER_RECOMMENDED_PRODUCT: RECOMMENDATION_SERVICE + 'userBased/',
};
...
export const DELIBVARY_CONTACT_INFO_API = {
     ...
     ADD_DELIVARY_CONTACT_INFO: DELIBVARY_CONTACT_INFO_SERVICE,
};
...
export const DELIBVARY_LOCATION_INFO_API = {
     ...
     ADD_DELIBVARY_LOCATION_INFO: DELIBVARY_LOCATION_INFO_SERVICE,
};

const RATING_SERVICE = SERVICE_API + 'api/rating/';
export const RATING_API = {
   // GET_PRODUCTS: PRODUCT_SERVICE + 'getAll',
    ADD_RATING: RATING_SERVICE,
    UPDATE_RATING: RATING_SERVICE,
    GET_RATTING:RATING_SERVICE+'getRating/'
    // UPDATE_PRODUCT: PRODUCT_SERVICE,
    // GET_PRODUCT_BY_ID: PRODUCT_SERVICE,
    // GET_PRODUCT_BY_SUB_CATEGORY_ID: PRODUCT_SERVICE+ 'getAllBySubCategory/',
    // GET_PRODUCT_BY_BRAND_ID: PRODUCT_SERVICE+ 'getAllByBrand/',
...
export const LOGIN_API = {
    LOGIN: LOGIN_SERVICE + 'user/login',
...
export const CATEGORY_API = {
    ...
    GET_CATEGORY_LIST: CATEGORY_SERVICE + 'getAllCategoryHierarchy',
